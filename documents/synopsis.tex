...
\item[Validate] Verify the physical correctness in the simulations, produced by using our project. 
		This could be done by making predictable test cases and evaluate if they react in the expected way. 
\item[Showcase] Show the capabilities of the system e.g. with a video of more complex simulations. We will discussed and
