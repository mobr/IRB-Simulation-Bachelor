...
\item[The prototype.] 	Familiarize ourself with: \emph{cmake}, \emph{Ogre3D}, \emph{Bullet}. 
			On a level where its possible to run, test and describe the prototype.
...
\item[Validate.] Verify the physical correctness produced by using our project.
\item[Showcase] Show the capabilities of the system e.g. with a movie of a simulation.
\end{description}
