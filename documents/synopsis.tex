...
\item[Complex tests] Be able to set up complex test scenarios with procedural content creation e.g. modelling an Eiffel tower and a
			greek temple.
\item[Validate] Verify the physical correctness of our procdural content creation solution. 
		This could be done by making predictable test cases and evaluate if they react in the physical correct way. 
\item[Showcase] Show the capabilities of the system e.g. with a video and screenshots of our more complex simulations.
\end{description}
