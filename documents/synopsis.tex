...
\item[The prototype] 	Familiarize ourself with: \emph{cmake}, \emph{Ogre3D}, \emph{Bullet}. 
			We need to be able to run, test and describe the existing prototype prototype.
...
\item[Validate.] Verify the physical correctness produced by using our project by making predictable test cases and evaluate if the react in the expected way. 
\item[Showcase] Show the capabilities of the system e.g. with a movie of a more complexing simulation.
\end{description}
...
\item[Week 42 to 45: Analysis of problem and its solution.] After gathering information we need to decide how we best solve the problem.
