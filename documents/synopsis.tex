...
\begin{itemize}
	\item The project will be limited to simple geometric shapes e.g. arches or domes.
...
\item[Interview] Prepare and conduct an interview with a possible end user or expert, to clarify how the current workflow of benchmarking is performed.
 		This interview should give us a solid understanding of how benchmarking is performed. It should help us
		identify key aspects of the process and give us a better understanding of what parameters, values and physical data
		is important to the benchmarking process.
\item[Physics attributes]Identify and describe physical attributes relevant to our project 
			and possible difficulties in the
...
\item[Complex tests] Set up more complex test scenarios easier with procedural content creation e.g. modelling an Eiffel tower and a
...
\item[Week 42: Related programming skills.] This week overlaps both the previous and the next schedule point and is about acquiring needed 
					   ...
					   templates and general C++ skills. There will not be an explanation of these subjects in the 
					   final report, but we need to allocate some time for studying this.

\item[Week 42 to 45: Analysis of problem and its solution.] Analysis of different possible solutions and their pros and cons. Using information
